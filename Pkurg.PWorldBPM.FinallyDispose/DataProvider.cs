...
namespace Pkurg.PWorldBPM.FinallyDispose
{
    ...
    {
        // 数据库连接字符串
        // public string ConnectionString = "Data Source=172.25.20.47;Initial Catalog=BPM;Persist Security Info=True;User ID=sa;Password=Founder@2014; Max Pool Size=150;Connect Timeout=500";

        public string ConnectionString = "Data Source=172.25.20.54;Initial Catalog=BPM;Persist Security Info=True;User ID=sa;Password=Fpkurg.123; Max Pool Size=150;Connect Timeout=500";

        public void SetConnectionType(ConnectionType connectionType)
        {
            switch (connectionType)
            {
                case ConnectionType.测试:
                    ConnectionString = "Data Source=172.25.20.47;Initial Catalog=BPM;Persist Security Info=True;User ID=sa;Password=Founder@2014; Max Pool Size=150;Connect Timeout=500";
                    break;
                case ConnectionType.正式:
                    ConnectionString = "Data Source=172.25.20.54;Initial Catalog=BPM;Persist Security Info=True;User ID=sa;Password=Fpkurg.123; Max Pool Size=150;Connect Timeout=500";
                    break;
                default:
                    break;
            }
