<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Originator.aspx.cs" Inherits="OrgWebSite.Process.CDF.Originator" %>
...
<body>
    ...
    <div>
        ...
        <table style="width: 640px; padding-top: 10px;">
            <tr>
                <td align="center">
                    <asp:ImageButton ID="btnRepSigner" runat="server" 
                        ImageUrl="~/Pic/button_huifusign_nor.png" onclick="btnRepSigner_Click" />&nbsp;&nbsp;
                    <asp:ImageButton ID="btnAccept" runat="server" 
                        ImageUrl="~/Pic/button_jieshouhuiqianyijian_nor.png" 
                        onclick="btnAccept_Click" />&nbsp;&nbsp;
                    <asp:ImageButton ID="btnNotAccept" runat="server" 
                        ImageUrl="~/Pic/button_bujieshouhuiqianyijian_nor.png" 
