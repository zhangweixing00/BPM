<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReSubmit.aspx.cs" Inherits="OrgWebSite.Process.CDF.ReSubmit" %>
...
<body>
    ...
    <div>
        ...
        <uc2:UCProcessAction ID="UCProcessAction1" runat="server" btnReworkCFCFVisible="true"
            CloseVisible="false" CommentsVisible="false" CancelVisible="true" Abandon="true" />
    </div>
    </form>
</body>
</html>
