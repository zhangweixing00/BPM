<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OriginatorConfirm.aspx.cs" Inherits="OrgWebSite.Process.CDF.OriginatorConfirm" %>
            ...
            <tr>
                <td align="center">
                    <asp:ImageButton ID="btnRepSigner" runat="server" 
                        ImageUrl="~/Pic/btnImg/btnConfirm_nor.png" onclick="btnRepSigner_Click" />&nbsp;&nbsp;
                </td>
            </tr>
        </table>
    </div>
