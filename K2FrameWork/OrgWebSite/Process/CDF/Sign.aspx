<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign.aspx.cs" Inherits="OrgWebSite.Process.CDF.Sign" %>
...
<body>
    ...
    <div>
        ...
        <table style="width: 640px; padding-top: 10px;">
            <tr>
                <td align="right">
                    <asp:ImageButton ID="btnOriginator" runat="server" ImageUrl="~/Pic/button_goutongfaqiren_nor.png"
                        OnClick="btnOriginator_Click" />
                </td>
                <td align="left">
                    <asp:ImageButton ID="btnGo" runat="server" ImageUrl="~/Pic/button_wuyiyi_nor.png"
                        OnClick="btnGo_Click" />
                </td>
            </tr>
        </table>
