...
3.时间比较验证格式 checkData:id1*id2,wrongMessage; 例 <input id="OnboardDate"  regex="checkData:OnboardDate*ContractEnd,合同结束日期必须大于入职日期;"  type="text" />
   ---王红福添加
4.时间比较验证格式 checkData2:id1*id2,wrongMessage; 例 <input id="OnboardDate"  regex="checkData2:OnboardDate*ContractEnd,合同结束日期必须大于等于入职日期;"  type="text" />
...
//比较时间      ---王红福添加
function CheckDate2(bdate, edate) {
