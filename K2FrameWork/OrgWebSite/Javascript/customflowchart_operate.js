...
//设置首个节点元素为当前人
var SetInitNode = function () {
    var name = document.getElementById('CDF1_EmployeeName').innerHTML;
    var code = document.getElementById('CDF1_hfApplicantCode').value;
    var deptname = document.getElementById('CDF1_DeptName').innerHTML;
    var deptcode = document.getElementById('CDF1_SecondDeptCode') + '.' + document.getElementById('CDF1_FirstDeptCode');
    chart.getNode(0).setNodeValue(name, code, deptname, deptcode, 'User', '', '');
    chart.paint();
    chart.Objserialize(chart, 'CDF1_hfjqFlowChart');     //序列化
};
...
//function setApproveRole(roleNames, roleCodes) {
$(document).ready(function () {
