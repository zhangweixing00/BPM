                        ...
                        switch (ruleArry[0]) {
                            ...
                            case "mustinputconfirm":
                                if ($.trim($("#" + inputid).val()) != "") {
                                    ...
                                    $("#OAF1_IT_TelCode").attr("regex", "mustNumber:必须输入数字");
                                }
                                else {
                                    if (faultCss != "") {
                                        $("#" + inputid).addClass(faultCss);
                                    ...
                                    window.ymPrompt.confirmInfo({ message: ruleArry[1], title: '', handler: function ConFirm(tp) { if (tp == 'ok') { $("#OAF1_IT_TelCode").removeAttr("regex"); $("#OAF1_IT_TelCode").attr("regex", "mustNumber:必须输入数字"); $("#UCProcessAction1_btnConfirm").click(); } } });
                                    //if (!confirm(ruleArry[1])) {
                                    // return false;
                                    //}
                                }
                                break;
                            //必填询问2                                                                                                                       
                            case "mustinputconfirm2":
                                if ($.trim($("#" + inputid).val()) != "") {
                                    if (faultCss != "") {
                                        $("#" + inputid).removeClass(faultCss);
                                        $("#" + inputid).parent().removeClass(faultCss);
                                        $("#" + inputid).parent().addClass("conter_right_list_input_bg");
                                        $("#OAF1_ES_TelCode").attr("regex", "mustNumber:必须输入数字");
                                    ...
                                    window.ymPrompt.confirmInfo({ message: ruleArry[1], title: '', handler: function ConFirm(tp) { if (tp == 'ok') { $("#OAF1_ES_TelCode").removeAttr("regex"); $("#OAF1_ES_TelCode").attr("regex", "mustNumber:必须输入数字"); $("#UCProcessAction1_btnConfirm").click(); } } });
                                    //if (!confirm(ruleArry[1])) {
                                    // return false;
                                    //}
                                }
