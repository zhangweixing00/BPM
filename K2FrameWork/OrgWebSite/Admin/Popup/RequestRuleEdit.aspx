<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestRuleEdit.aspx.cs"
    Inherits="OrgWebSite.Admin.Popup.RequestRuleEdit" %>
        ...
        <table border="0" cellpadding="0" width="500px" cellspacing="0">
            <tr style=" display:none;">
                ...
                <td class="table_content">
                    <asp:TextBox ID="txtDisplayName" runat="server" Width="340px" Text="RoleName" CssClass="txtcss" MaxLength="50"
                        ToolTip=""></asp:TextBox>
                </td>
                <td class="table_xing">
            ...
            <tr style=" display:none;">
                ...
                <td class="table_content">
                    <asp:TextBox ID="txtTableName" runat="server" Width="340px" Text="PWorld.dbo.T_PmsRole" CssClass="txtcss" MaxLength="50"
                        ToolTip=""></asp:TextBox>
                </td>
                <td class="table_xing">
                    <div style="color: Red;" id="div2" runat="server">
                        *</div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="table_content">
                    <asp:TextBox ID="txtConditionExpression" Visible="false" runat="server" TextMode="MultiLine" Width="340px"
                ...
                <td class="table_xing">
                    <div style="color: Red;" id="div3" runat="server">
                        *</div>
                </td>
            </tr>
            <tr>
