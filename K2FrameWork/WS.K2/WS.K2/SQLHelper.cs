...
namespace WS.K2
{
    ...
    public abstract class SqlHelper
    {
        ...
        //public static readonly string ConnectionStringLocalTransaction = ConfigurationManager.ConnectionStrings["ConnectionStringLocal"].ConnectionString;
        ...
        public static int ExecuteNonQuery(CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection conn = new SqlConnection(ConnectionStringTransaction))
            {
        ...
        {
            SqlCommand cmd = new SqlCommand();
            SqlConnection conn = new SqlConnection(ConnectionStringTransaction);
        ...
        public static object ExecuteScalar( CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionStringTransaction))
            {
                PrepareCommand(cmd, connection, null, cmdType, cmdText, commandParameters);
