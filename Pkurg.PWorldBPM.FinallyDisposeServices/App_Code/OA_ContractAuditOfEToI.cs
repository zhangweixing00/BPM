...
/// <summary>
///OA_ContractAuditOfEToI 的摘要说明
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
//若要允许使用 ASP.NET AJAX 从脚本中调用此 Web 服务，请取消对下行的注释。 
// [System.Web.Script.Services.ScriptService]
public class OA_ContractAuditOfEToI : Pkurg.PWorldBPM.FinallyDisposeServices.FinallyDisposeServiceBase
{
    ...
    {
        Logger.logger.DebugFormat("OA_ContractAuditOfEToI_Params:{0},{1}", k2_workflowId, dataFields["IsReport"] == "1" ? "上报" : "不上报");
        ...
        try
        {
            ...
            {
                Pkurg.PWorldBPM.Business.BIZ.OA.ContractAuditOfEToIInfo companyInfo = new Pkurg.PWorldBPM.Business.BIZ.OA.ContractAuditOfEToI().GetInfoByWfId(k2_workflowId.ToString());
                ...
                {
                    ///增加表单
                    string formId = Pkurg.PWorldBPM.Business.Controls.WF_WorkFlowInstances.GetSerialNumber("OA_IHT_");
                    new Pkurg.PWorldBPM.Business.BIZ.OA.ContractAuditOfPKURGI().Insert(new Pkurg.PWorldBPM.Business.BIZ.OA.ContractAuditOfPKURGIInfo()
                    {
                        FormID = formId,
