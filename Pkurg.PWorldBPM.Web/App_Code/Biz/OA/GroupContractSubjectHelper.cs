...
/// <summary>
///ContractSubjectHelper 的摘要说明
/// </summary>
public class ContractSubjectHelper
{
    public static List<ContractTypeInfo> GetContractSubjectInfos()
    {
        ...
        if (HttpContext.Current.Cache[cacheName_ContractSubjectInfos] == null)
        {
            ...
            string filePath = HttpContext.Current.Server.MapPath("~/Files/xml/GroupContractSubject.xml");
    ...
    public static object GetContractSubjectInfos1()
    {
        string cacheName_ContractSubjectInfos = "cacheName_ContractSubjectInfos";
        if (HttpContext.Current.Cache[cacheName_ContractSubjectInfos] == null)
        {
            XmlDocument doc = new XmlDocument();
            string filePath = HttpContext.Current.Server.MapPath("~/Files/xml/WYXML/WY_ContractSubject.xml");
            if (!File.Exists(filePath))
            {
                throw new Exception("不存在ContractSubject文件");
            }
