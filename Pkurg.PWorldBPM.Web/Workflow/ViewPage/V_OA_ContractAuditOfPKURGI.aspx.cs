...
public partial class Workflow_ViewPage_V_OA_ContractAuditOfPKURGI : System.Web.UI.Page
{
    ContractAuditOfPKURGI Vitems = new ContractAuditOfPKURGI();
    ...
    private void BindFormData()
    {
        try
        {
            ...
            ContractAuditOfPKURGIInfo obj = Vitems.Get(Instance.FormId.ToString());
            if (obj == null)
            {
                ExceptionHander.GoToErrorPage("记录不存在");
            }
