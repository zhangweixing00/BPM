...
<%@ Register src="../../../Modules/ApprovalBox/ApprovalBox.ascx" tagname="ApprovalBox" tagprefix="uc1" %>
<%@ Register src="../../../Modules/UploadAttachments/UploadAttachments.ascx" tagname="UploadAttachments" tagprefix="uc2" %>
<div class="wf_form">
            ...
            <tbody>
                ...
                <tr>
                    <th>
                        关联流程：</th>
                    <td colspan="3">
                        <uc3:FlowRelated ID="FlowRelated1" runat="server"  IsCanEdit="false"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td colspan="3">
                        ...
                        <uc2:UploadAttachments ID="UploadAttachments1" runat="server" />
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <uc1:ApprovalBox ID="ApprovalBox3" runat="server"  ShowActivityName="部门负责人审批"/>
                ...
                <tr>
                    ...
                    <td>
                        <uc1:ApprovalBox ID="ApprovalBox1" runat="server" ShowActivityName="会签" />
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <uc1:ApprovalBox ID="ApprovalBox2" runat="server" ShowActivityName="部门主管领导审批"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <uc1:ApprovalBox ID="ApprovalBox4" runat="server" ShowActivityName="CEO审批"/>
                    </td>
                </tr>
            </tbody>
        </table>
