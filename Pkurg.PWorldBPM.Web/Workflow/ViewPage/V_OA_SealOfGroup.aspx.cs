...
public partial class Workflow_ViewPage_V_OA_SealOfGroup : System.Web.UI.Page
{
    SealOfGroup Vitems = new SealOfGroup();
    ...
    private void BindFormData()
    {
        try
        {
            ...
            SealOfGroupInfo obj = Vitems.Get(Instance.FormId.ToString());
            if (obj == null)
            {
                ExceptionHander.GoToErrorPage("记录不存在");
            }
