...
public partial class Workflow_ViewPage_V_OA_ContractAuditOfEToG : System.Web.UI.Page
{
    ContractAuditOfEToG Vitems = new ContractAuditOfEToG();
    ...
    private void BindFormData()
    {
        try
        {
            ...
            ContractAuditOfEToGInfo obj = Vitems.Get(Instance.FormId.ToString());
            if (obj == null)
            {
                ExceptionHander.GoToErrorPage("记录不存在");
            }
