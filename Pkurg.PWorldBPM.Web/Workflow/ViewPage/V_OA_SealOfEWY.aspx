<%@ Page Language="C#" AutoEventWireup="true" CodeFile="V_OA_SealOfEWY.aspx.cs" Inherits="Workflow_ViewPage_V_OA_SealOfEWY" %>
                    ...
                    <table id="tb1" class="wf_table2" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <UA:uploadattachments id="UploadAttachments1" runat="server" iscanedit="false" appid="3026" IsOnlyRead="true"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
