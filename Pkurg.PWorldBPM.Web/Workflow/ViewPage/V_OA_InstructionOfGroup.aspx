<%@ Page Language="C#" AutoEventWireup="true" CodeFile="V_OA_InstructionOfGroup.aspx.cs"
    Inherits="Workflow_ViewPage_V_OA_InstructionOfGroup" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="false" AppId="3003" IsOnlyRead="true"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr id="trDutyFreeOpinion" runat="server" visible="false">
                                ...
                                <td>
                                    <uc4:ApproveOpinionUC ID="OpinionRelatedManager" CurrentNode="false" CurrentNodeName="条线负责人意见"
                                        runat="server" />
                                    <uc4:ApproveOpinionUC ID="OpinionDutyFreeManager" CurrentNode="false" CurrentNodeName="免税店领导意见"
                                        runat="server" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbPresident" runat="server" Text="选择总裁" Visible="false"/>
