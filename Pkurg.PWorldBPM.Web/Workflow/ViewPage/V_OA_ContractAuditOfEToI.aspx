<%@ Page Language="C#" AutoEventWireup="true" CodeFile="V_OA_ContractAuditOfEToI.aspx.cs" 
Inherits="Workflow_ViewPage_V_OA_ContractAuditOfEToI" %>
        ...
        <div class="wf_center" style="width: 980px;">
            ...
            <div class="wf_form" id="wf_form_title" runat="server">
                <div class="wf_form_title">
                    合同流程单<asp:Label id="lbIsApproval" runat="server"></asp:Label><br />
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="false" AppId="3006" IsOnlyRead="true"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
