...
public partial class Workflow_ApprovePage_A_OA_ContractAuditOfEToI : UPageBase
{
    ContractAuditOfEToI Aitems = new ContractAuditOfEToI();
    ...
    private void BindFormData()
    {
        try
        {
            ContractAuditOfEToIInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
                //保存数据
