...
public partial class Workflow_ApprovePage_A_OA_InstructionOfGroup : UPageBase
{
    InstructionOfGroup Aitems = new InstructionOfGroup();
    ...
    private void ShowButton()
    {
        ...
        if (K2_TaskItem != null && K2_TaskItem.ActivityInstanceDestination.Name == "流程审核员上报")
        {
            UnOptions.Visible = false;
            lbAgree.Text = "提交";
        }
    ...
    private void InitCheckBoxList()
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            InstructionOfGroupInfo formDataInfo = Aitems.Get(FormID);
    ...
    private void BindFormData()
    {
        try
        {
            InstructionOfGroupInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
    ...
    private List<UserControls_ApproveOpinionUC> GetOptions()
    {
        ...
        options.Add(OpinionRelatedManager);
        options.Add(OpinionDutyFreeManager);
        return options;
    }
