...
public partial class Workflow_ApprovePage_A_OA_ContractAuditOfPKURGI : UPageBase
{
    ContractAuditOfPKURGI Aitems = new ContractAuditOfPKURGI();
    ...
    private void InitCheckBoxList()
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            ContractAuditOfPKURGIInfo formDataInfo = Aitems.Get(FormID);
    ...
    private void BindFormData()
    {
        try
        {
            ContractAuditOfPKURGIInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
                //保存数据
