...
public partial class Workflow_ApprovePage_A_JC_FinalistApproval : UPageBase
{
  ...
  private void InitFormData(string formId)
    ...
    public string GetViewUrl()
    {
        ...
        ViewUrl = StrTemp + "ViewPage/V_JC_FinalistApproval.aspx?ID=" + Request.QueryString["id"];
        return ViewUrl;
    }
}