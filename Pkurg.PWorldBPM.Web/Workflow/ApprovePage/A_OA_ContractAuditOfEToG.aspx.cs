...
public partial class Workflow_ApprovePage_A_OA_ContractAuditOfEToG : UPageBase
{
    ContractAuditOfEToG Aitems = new ContractAuditOfEToG();
    ...
    private void InitCheckBoxList()
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            ContractAuditOfEToGInfo formDataInfo = Aitems.Get(FormID);
    ...
    private void BindFormData()
    {
        try
        {
            ContractAuditOfEToGInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
                //保存数据
