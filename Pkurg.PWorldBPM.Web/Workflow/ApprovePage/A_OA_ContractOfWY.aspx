...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_OA_ContractOfWY.aspx.cs"
    Inherits="Workflow_ApprovePage_A_OA_ContractOfWY" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="ddlContractType1" runat="server" ReadOnly="true" Width="200px" Height="20px">
                                    </asp:TextBox>
                                    <asp:TextBox ID="ddlContractType2" runat="server" ReadOnly="true" Width="200px" Height="20px">
                                    </asp:TextBox>
                                    <asp:TextBox ID="ddlContractType3" runat="server" ReadOnly="true" Width="200px" Height="20px">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbContractSum" runat="server" CssClass="longtxt" Width="300" ReadOnly="true"
                                        BackColor="White"></asp:TextBox>元
                                </td>
                                <th>
                                    是否补充协议：
                                </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="ddlContractSubject" runat="server" ReadOnly="True" Width="300px"
                                        Height="20px"></asp:TextBox>
                                    <br />
                                    <asp:TextBox ID="tbContractSubject1" runat="server" CssClass="longtxt" Width="300"
                                        ReadOnly="True" BackColor="White"></asp:TextBox>
                                </td>
                                <td colspan="3">
                                    <asp:TextBox ID="tbContractSubject2" runat="server" CssClass="longtxt" Width="300"
                                        ReadOnly="True" BackColor="White"></asp:TextBox>
                                    <br />
                                    <asp:TextBox ID="tbContractSubject3" runat="server" CssClass="longtxt" Width="300"
                                        ReadOnly="True" BackColor="White"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="tbContractTitle" runat="server" CssClass="longtxt" Width="700" ReadOnly="True"
