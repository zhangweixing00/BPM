...
public partial class Workflow_ApprovePage_A_OA_SealOfGroup : UPageBase
{
    SealOfGroup Aitems = new SealOfGroup();
    ...
    private void InitCheckBoxList()
    {
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            SealOfGroupInfo formDataInfo = Aitems.Get(FormID);
    ...
    private void BindFormData()
    {
        try
        {
            SealOfGroupInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
