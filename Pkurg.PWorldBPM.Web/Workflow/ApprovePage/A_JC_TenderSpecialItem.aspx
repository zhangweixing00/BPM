<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_JC_TenderSpecialItem.aspx.cs"
    Inherits="Workflow_ApprovePage_A_JC_TenderSpecialItem" %>
...
<%@ Register Src="../../Modules/Countersign/Countersign_Group.ascx" TagName="Countersign_Group"
    TagPrefix="CSG" %>
<%@ Register src="../../Modules/ChangeSign/ChangeSign.ascx" tagname="ChangeSign" tagprefix="uc5" %>
                ...
                <fieldset class="wf_fieldset">
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <uc1:UploadAttachments ID="UploadAttachments1" runat="server" AppId="2006" IsCanEdit="true" />
    ...
    <div id="scroll">
        ...
        <div id="scroll_button">
            ...
            <ul class="scroll_ul">
                ...
                <uc5:ChangeSign ID="ChangeSign1" runat="server" />
