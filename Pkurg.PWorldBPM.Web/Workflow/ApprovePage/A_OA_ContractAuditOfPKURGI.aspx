<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_OA_ContractAuditOfPKURGI.aspx.cs" 
Inherits="Workflow_ApprovePage_A_OA_ContractAuditOfPKURGI" %>
                    ...
                    <table class="wf_table">
                        <tbody>
                            ...
                            <tr id="trPresident" runat="server" visible ="false">
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbCEO" runat="server" Text="选择总经理/董事"  Enabled="false"/>
