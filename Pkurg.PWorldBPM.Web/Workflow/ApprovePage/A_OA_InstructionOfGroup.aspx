<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_OA_InstructionOfGroup.aspx.cs"
    Inherits="Workflow_ApprovePage_A_OA_InstructionOfGroup" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="false" AppId="3003" />
                ...
                <fieldset class="wf_fieldset">
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr id="trDutyFreeOpinion" runat="server">
                                <th>
                                    相关领导意见：
                                </th>
                                <td>
