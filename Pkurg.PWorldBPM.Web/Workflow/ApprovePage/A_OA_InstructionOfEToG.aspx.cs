...
public partial class Workflow_ApprovePage_A_OA_InstructionOfEToG : UPageBase
{
    InstructionOfEToG Aitems = new InstructionOfEToG();
    ...
    private void InitCheckBoxList()
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            InstructionOfEToGInfo formDataInfo = Aitems.Get(FormID);
    ...
    private void BindFormData()
    {
        try
        {
            InstructionOfEToGInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
