<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_OA_SealOfWY.aspx.cs" Inherits="Workflow_ApprovePage_A_OA_SealOfWY" %>
                    ...
                    <table id="tb1" class="wf_table2" cellspacing="1" cellpadding="0">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbDeptName" runat="server" CssClass="txt" Width="330px" ReadOnly="true"></asp:TextBox>
                                </td>
                                <th>
                                    经办人：
                                </th>
