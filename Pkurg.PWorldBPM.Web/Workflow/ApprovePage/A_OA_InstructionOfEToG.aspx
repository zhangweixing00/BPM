<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_OA_InstructionOfEToG.aspx.cs"
    Inherits="Workflow_ApprovePage_A_OA_InstructionOfEToG" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbPresident" runat="server" Text="选择总裁/总经理" Enabled="false" />
