...
public partial class Workflow_ApprovePage_A_OA_InstructionOfPKURGI : UPageBase
{
    InstructionOfPKURGI Aitems = new InstructionOfPKURGI();
    ...
    private void InitCheckBoxList()
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            InstructionOfPKURGIInfo formDataInfo = Aitems.Get(FormID);
    ...
    private void BindFormData()
    {
        try
        {
            InstructionOfPKURGIInfo obj = Aitems.Get(FormID);
            if (obj != null)
            {
