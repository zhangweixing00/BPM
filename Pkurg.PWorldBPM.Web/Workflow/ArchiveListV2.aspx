<%@ Page Title="" Language="C#" MasterPageFile="~/BPM.master" AutoEventWireup="true"
    CodeFile="ArchiveListV2.aspx.cs" Inherits="Workflow_ArchiveListV2" Trace="true" %>
                    ...
                    <table class="FormTable">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbStarter" runat="server" CssClass="txt" MaxLength="50" Width="150px"></asp:TextBox>
                                </td>
                                <th>
                                    发起部门:
                                </th>
                                <td>
                                    <asp:TextBox ID="tbStartDept" runat="server" CssClass="txt" MaxLength="50" Width="150px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlflowTypes" runat="server"   Width="150px">
                                    </asp:DropDownList>
                                </td>
                                <th>
                                    状态：
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlStatus" runat="server" Width="150px">
                                        ...
                                        <asp:ListItem Value="5">强制结束</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    &nbsp;
            ...
            <div class="container">
                ...
                <div class="content">
                    <asp:Repeater ID="lblBPMList" runat="server" OnItemCommand="lblBPMList_ItemCommand"
                        ...
                        <ItemTemplate>
                            <tr onmouseover="c=this.style.backgroundColor;this.style.backgroundColor='#F3F3F3';"
                                ...
                                <td>
                                    <a onclick='ViewHistory("<%# Eval("bpmid")%>")' href='#'>
                                ...
                                <td width="50px">
                                    <%#GetStatusText(Eval("IsPass").ToString())%>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                    ...
                    <pager:AspNetPager ID="AspNetPager2" runat="server" CssClass="anpager" CurrentPageButtonClass="cpb"
                        FirstPageText="首页" LastPageText="尾页" NextPageText="后页" PrevPageText="前页" OnPageChanged="AspNetPager2_PageChanged"
                        PageSize="5">
                    </pager:AspNetPager>
                </div>
            </div>
