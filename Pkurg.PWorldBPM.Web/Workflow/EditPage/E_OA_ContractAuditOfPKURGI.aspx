<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_OA_ContractAuditOfPKURGI.aspx.cs"
    Inherits="Workflow_EditPage_E_OA_ContractAuditOfPKURGI" %>
    ...
    <div class="wf_page">
        ...
        <div class="wf_center" style="width: 980px;">
            ...
            <div class="wf_form" id="wf_form_title" runat="server">
                ...
                <div class="wf_form_title_en">
                    Peking University Resources Group Investment Company Limited</div>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlEstateProjectName" runat="server" Width="200px" Height="20px">
                                        ...
                                        <asp:ListItem Value="22">北大资源悦来项目</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="true" AppId="3005" />
                    ...
                    <table class="wf_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan='2'>
                                    ...
                                    <uc4:ApproveOpinionUC ID="OpinionVP" CurrentNode="false" CurrentNodeName="相关部门主管副总裁意见"
                                        runat="server" />
                                    <uc4:ApproveOpinionUC ID="OpinionDirectors" CurrentNode="false" CurrentNodeName="其他董事意见"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr id="trPresident" runat="server" visible="false">
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbCEO" runat="server" Text="选择总经理/董事" />
                                    <asp:Label ID="lbCEO" runat="server"></asp:Label>
                                    <uc4:ApproveOpinionUC ID="OpinionCEO" CurrentNode="false" CurrentNodeName="总经理/董事意见"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr>
