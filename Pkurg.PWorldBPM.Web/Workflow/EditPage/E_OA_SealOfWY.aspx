<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_OA_SealOfWY.aspx.cs" Inherits="Workflow_EditPage_E_OA_SealOfWY" %>
                    ...
                    <table id="tb1" class="wf_table2" cellspacing="1" cellpadding="0">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlDeptName" runat="server" AutoPostBack="True" Width="330px"
                    ...
                    <table class="wf_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                <asp:CheckBox ID="cbAP" runat="server" Text="选择相关部门主管助理总裁" Checked="true" />
                                    <asp:Label ID="lbAP" runat="server"></asp:Label>
                                    <asp:CheckBox ID="cbVP" runat="server" Text="选择相关部门主管副总裁" Checked="true" />
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                <asp:CheckBox ID="cbPresident" runat="server" Text="选择总裁" Checked="true"/>
