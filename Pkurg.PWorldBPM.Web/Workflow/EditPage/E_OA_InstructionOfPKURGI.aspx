<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_OA_InstructionOfPKURGI.aspx.cs"
    Inherits="Workflow_EditPage_E_OA_InstructionOfPKURGI" %>
    ...
    <div class="wf_page">
        ...
        <div class="wf_center" style="width: 980px;">
            ...
            <div class="wf_form" id="wf_form_title" runat="server">
                ...
                <div class="wf_form_title_en">Peking University Resources Group Investment Company Limited</div>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbUserName" runat="server" CssClass="txt" Width="100px"></asp:TextBox>
                                </td>
                                <th>
                                    电话：
                                </th>
                                <td>
                                    <asp:TextBox ID="tbMobile" runat="server" CssClass="txt" Width="100px"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="true" AppId="3001" />
                    ...
                    <table class="wf_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan='2'>
                                    ...
                                    <uc4:ApproveOpinionUC ID="OpinionVP" CurrentNode="false" CurrentNodeName="相关部门主管副总裁意见"
                                        runat="server" />
                                    <uc4:ApproveOpinionUC ID="OpinionDirectors" CurrentNode="false" CurrentNodeName="董事意见"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr id="trPresident" runat="server" visible="false">
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbPresident" runat="server" Text="选择总经理"/>
