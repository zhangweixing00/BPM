<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_OA_InstructionOfEToG.aspx.cs"
    Inherits="Workflow_EditPage_E_OA_InstructionOfEToG" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="true" AppId="3004" />
                    ...
                    <table class="wf_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbPresident" runat="server" Text="选择总裁/总经理" />
