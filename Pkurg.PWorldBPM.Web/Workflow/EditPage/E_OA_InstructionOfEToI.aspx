<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_OA_InstructionOfEToI.aspx.cs"
    Inherits="Workflow_EditPage_E_OA_InstructionOfEToI" %>
            ...
            <div class="wf_form" id="wf_form_title" runat="server">
                ...
                <table class="wf_table" cellpadding="0" cellspacing="1">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="tbReportCode" runat="server" contentEditable="false" Width="180px"
                                CssClass="txt" />
                        </td>
                        <th>
                            保密等级：
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="true" AppId="3002" />
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan='2'>
                                    ...
                                    <asp:Label ID="lbDirector" runat="server" Font-Bold="true">若还需要其他总办会领导审批，请勾选</asp:Label>
