<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_ERP_ContractApproval.aspx.cs"
    Inherits="Workflow_EditPage_E_ERP_ContractApproval" %>
...
<body>
                    ...
                    <table class="wf_table" colspan="1">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <CSG:Countersign_Group ID="Countersign_Group1" runat="server" IsCanEdit="true" DefaultCheckdDepartments="财务管理部"
                                        DisableDepartments='法务部,财务管理部' />
                                </td>
                            </tr>
                            <tr>
                                <th>
    ...
    <div id="scroll" style="margin-left: 520px;">
        ...
        <div id="scroll_button">
            <!--根据需要，放入按钮-->
            <ul class="scroll_ul">
                <asp:LinkButton ID="lbSave" runat="server" OnClick="Save_Click" Visible="false">保存</asp:LinkButton>
                <li>
                ...
                <asp:LinkButton ID="lbDelete" runat="server" OnClick="lbDelete_Click" Visible="false">终止</asp:LinkButton>
            </ul>
        </div>
    </div>
    </form>
