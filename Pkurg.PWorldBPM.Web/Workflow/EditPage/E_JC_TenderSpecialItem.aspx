<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_JC_TenderSpecialItem.aspx.cs" 
Inherits="Workflow_EditPage_E_JC_TenderSpecialItem" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="true" AppId="2006" />
                        ...
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td colspan="2">
                                    <CSG:Countersign_Group ID="Countersign_Group1" runat="server" IsCanEdit="true" DisableDepartments='法务部'/>
                                </td>
                            </tr>
                            <tr>
                                <th>
