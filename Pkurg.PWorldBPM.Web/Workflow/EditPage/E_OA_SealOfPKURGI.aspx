<%@ Page Language="C#" AutoEventWireup="true" CodeFile="E_OA_SealOfPKURGI.aspx.cs"
    Inherits="Workflow_EditPage_E_OA_SealOfPKURGI" %>
                    ...
                    <table class="wf_table" cellspacing="1" cellpadding="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <uc1:UploadAttachments ID="UploadAttachments1" runat="server" IsCanEdit="true" AppId="3009" />
                    ...
                    <table class="wf_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <uc3:Countersign ID="Countersign1" runat="server" IsCanEdit="true" IsCanSelectSelfDeptment="false" ViewStateMode="Enabled"/>
                            ...
                            <tr id="trPresident" runat="server" visible="false">
                                ...
                                <td colspan="2">
                                    <asp:CheckBox ID="cbPresident" runat="server" Text="选择总经理" Checked="false"/>
