...
public partial class Workflow_EditPage_E_OA_InstructionOfPKURGI : UPageBase
{
    public string className = "Workflow_EditPage_E_OA_InstructionOfPKURGI";

    InstructionOfPKURGI Eitems = new InstructionOfPKURGI();
    ...
    protected void Save_Click(object sender, EventArgs e)
    {
        ...
        InstructionOfPKURGIInfo obj = SaveData(id, "00");
        if (obj != null)
        {
