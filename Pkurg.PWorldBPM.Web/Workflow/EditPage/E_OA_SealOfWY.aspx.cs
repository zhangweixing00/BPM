...
[BPM(AppId = "3025")]
public partial class Workflow_EditPage_E_OA_SealOfWY : E_WorkflowFormBase
{
    string WYZHDeptCode = System.Configuration.ConfigurationManager.AppSettings["WYZHDeptCode"];
    string WYCode = System.Configuration.ConfigurationManager.AppSettings["WYCode"];
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                FormId = BPMHelp.GetSerialNumber("OA_WYYZ_");
    ...
    protected override List<K2_DataFieldInfo> LoadUserDataField()
    {
        ...
        {
            dfInfos.Add(new K2_DataFieldInfo() { DeptCode = WYCode, RoleName = "总裁", Name = "President" });
        }
        else
        {
        ...
        dfInfos.Add(new K2_DataFieldInfo() { DeptCode = WYZHDeptCode, RoleName = "部门负责人", Name = "SealDeptManager" });
        dfInfos.Add(new K2_DataFieldInfo() { DeptCode = WYCode, RoleName = "公章管理员", Name = "SealManager" });
    ...
    private void InitLeader()
    {
        ...
        DataTable dtPresident = bfurd.GetSelectRoleUser(WYCode, "总裁");
        DataTable dtZHDeptManager = bfurd.GetSelectRoleUser(WYZHDeptCode, "部门负责人");
