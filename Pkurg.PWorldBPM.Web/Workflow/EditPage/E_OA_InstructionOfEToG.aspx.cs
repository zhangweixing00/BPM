...
public partial class Workflow_EditPage_E_OA_InstructionOfEToG : UPageBase
{
    public string className = "Workflow_EditPage_E_OA_InstructionOfEToG";

    InstructionOfEToG Eitems = new InstructionOfEToG();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                FormId = BPMHelp.GetSerialNumber("OA_EQS_");
    ...
    private void InitCheckBoxList()
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["id"]))
        {
            ...
            InstructionOfEToGInfo formDataInfo = Eitems.Get(FormId);
    ...
    private void BindFormData()
    {
        try
        {
            InstructionOfEToGInfo obj = Eitems.Get(ViewState["FormID"].ToString());
    ...
    private InstructionOfEToGInfo SaveData(string ID, string wfStatus)
    {
        SaveWFParams();
        InstructionOfEToGInfo obj = null;
        try
        {
    ...
    private bool SaveWorkFlowInstance(InstructionOfEToGInfo obj, string WfStatus, DateTime? SumitTime, string WfInstanceId)
    {
        bool result = false;
    ...
    protected void Save_Click(object sender, EventArgs e)
    {
        ...
        InstructionOfEToGInfo obj = SaveData(id, "00");
        if (obj != null)
        {
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        ...
        InstructionOfEToGInfo obj = SaveData(id, "02");
        if (obj != null)
        {
            //开启流程
            WorkflowHelper.CurrentUser = "founder\\" + _BPMContext.CurrentUser.LoginId;
            ...
            WorkflowHelper.StartProcess(@"K2Workflow\OA_InstructionOfEToG", id, dataFields, ref wfInstanceId);
            if (wfInstanceId > 0)
            {
