<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddSign.ascx.cs" Inherits="Modules_AddSign_AddSign" %>
<li><div id="div_content"  runat="server"></div></li>
<script type="text/javascript" src="/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript">
    function AddSign(instId, sn) {
        ...
        var sUrl = "/Modules/AddSign/DoAddSignV2.aspx?id=" + encodeURI(instId) + "&sn=" + sn + "&optionTxt=" + encodeURI(txt);
