<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeOperation.aspx.cs" Inherits="Modules_BaseData_EmployeeOperation" %>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="btnClose" runat="server" Text=" 关闭 " CssClass="gray_btn2" OnClientClick="javascript:window.returnValue=;window.close();" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="content">
                    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="List"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="MobilePhone" HeaderText="电话" />
