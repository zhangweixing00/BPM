...
{
    public class InstructionOfEToG
    {
        ...
        /// <returns></returns>
        public bool Insert(InstructionOfEToGInfo model)
        {
            string sql = string.Format("INSERT INTO Biz.OA_InstructionOfEToG (FormID,SecurityLevel,UrgenLevel,DeptName ,DeptCode,UserName," +
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool Update(InstructionOfEToGInfo model)
        {
            string sql = string.Format("Update Biz.OA_InstructionOfEToG set SecurityLevel='{0}',UrgenLevel = '{1}',DeptName = '{2}',DeptCode='{3}'," +
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_InstructionOfEToG SET  IsApproval = '{0}'"
        ...
        {
            string sql = string.Format("DELETE FROM Biz.OA_InstructionOfEToG WHERE FormID='{0}'", FormID);
            return DBHelper.ExecuteNonQuery(sql);
        }

        public InstructionOfEToGInfo Get(string FormID)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
            parameters[0].Value = FormID;
            DataTable dt = DBHelper.ExecutedProcedure("Biz.OA_InstructionOfEToG_Get", parameters);
            InstructionOfEToGInfo Info = new InstructionOfEToGInfo();
        ...
        public InstructionOfEToGInfo GetInfoByWfId(string wfInstanceId)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@WFInstanceId", System.Data.SqlDbType.NVarChar, 100)
            };
            parameters[0].Value = wfInstanceId;
            DataTable dt = DBHelper.ExecutedProcedure("Biz.OA_InstructionOfEToG_GetBywfId", parameters);
            InstructionOfEToGInfo Info = new InstructionOfEToGInfo();
            if (dt != null && dt.Rows.Count > 0)
            {
                Info.FormID = Assign(dt.Rows[0]["FormID"]);
        ...
        #endregion
        //app3004
        public InstructionOfEToGInfo GetInstructionOfEToGInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
