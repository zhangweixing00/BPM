...
{
   public class ContractAuditOfGroup
    {
        /// <summary>
        /// 通过FormID得到ContractAuditOfGroupInfo的信息
        /// </summary>
        /// <param name="p"></param>
        /// <returns></returns>
       public ContractAuditOfGroupInfo Get(string FormID)
        {
           ...
           new SqlParameter("@FormID",System.Data.SqlDbType.NVarChar,100),
            ...
            ContractAuditOfGroupInfo model = new ContractAuditOfGroupInfo();
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfGroupInfoByFormID_Get", parameters);
        ...
        /// <returns></returns>
       private ContractAuditOfGroupInfo DataRowToModel(DataRow dataRow)
        {
            ContractAuditOfGroupInfo info = new ContractAuditOfGroupInfo();
       ...
       public void Insert(ContractAuditOfGroupInfo model)
        {
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfGroupInfo_Insert", parameters);
        }
        /// <summary>
        /// 更新表
        /// </summary>
        /// <param name="obj"></param>
       public void Update(ContractAuditOfGroupInfo model)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@FormID", SqlDbType.NVarChar,100),
					new SqlParameter("@SecurityLevel", SqlDbType.NVarChar,100),
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfGroupInfo_Update", parameters);
        }
        /// <summary>
        /// 更新状态
        /// </summary>
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_ContractAuditOfGroup SET  IsApproval = '{0}'"
                                        + " where FormID = '{1}'", strStatus, ID);
            return DBHelper.ExecuteNonQuery(sql);
        }
       //app3007
        public ContractAuditOfGroupInfo GetContractAuditOfGroupInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[] { 
           new SqlParameter("@FormID",System.Data.SqlDbType.NVarChar,100),
           };
