...
{
    public class ContractAuditOfPKURGI
    {
        /// <summary>
        /// 通过FormID得到ContractAuditOfPKURGIInfo的信息
        /// </summary>
        /// <param name="p"></param>
        /// <returns></returns>
        public ContractAuditOfPKURGIInfo Get(string FormID)
        {
           ...
           new SqlParameter("@FormID",System.Data.SqlDbType.NVarChar,100),
            ...
            ContractAuditOfPKURGIInfo model = new ContractAuditOfPKURGIInfo();
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfPKURGIInfoByFormID_Get", parameters);
        ...
        /// <returns></returns>
        private ContractAuditOfPKURGIInfo DataRowToModel(DataRow dataRow)
        {
            ContractAuditOfPKURGIInfo info = new ContractAuditOfPKURGIInfo();
        ...
        public void Insert(ContractAuditOfPKURGIInfo model)
        {
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfPKURGIInfo_Insert", parameters);
        }
        /// <summary>
        /// 更新表
        /// </summary>
        /// <param name="obj"></param>
        public void Update(ContractAuditOfPKURGIInfo model)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@FormID", SqlDbType.NVarChar,100),
					new SqlParameter("@SecurityLevel", SqlDbType.NVarChar,100),
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfPKURGIInfo_Update", parameters);
        }
        /// <summary>
        /// 更新状态
        /// </summary>
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_ContractAuditOfPKURGI SET  IsApproval = '{0}'"
                                        + " where FormID = '{1}'", strStatus, ID);
            return DBHelper.ExecuteNonQuery(sql);
        }
        //app3005
        public ContractAuditOfPKURGIInfo ContractAuditOfPKURGIInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[] { 
           new SqlParameter("@FormID",System.Data.SqlDbType.NVarChar,100),
           };
