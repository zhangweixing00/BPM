...
namespace Pkurg.PWorldBPM.Business.BIZ
{
    public class SealOfBC
    {
        ...
        /// <returns></returns>
        public bool Insert(SealOfBCInfo model)
        {
            string sql = string.Format("INSERT INTO Biz.OA_SealOfBC (FormID,SecurityLevel,UrgenLevel,DeptName ,DeptCode,UserName," +
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool Update(SealOfBCInfo model)
        {
            string sql = string.Format("Update Biz.OA_SealOfBC set SecurityLevel='{0}',UrgenLevel = '{1}',DeptName = '{2}',DeptCode='{3}'," +
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_SealOfBC SET  IsApproval = '{0}'"
        ...
        {
            string sql = string.Format("DELETE FROM Biz.OA_SealOfBC WHERE FormID='{0}'", FormID);
            return DBHelper.ExecuteNonQuery(sql);
        }

        public SealOfBCInfo Get(string FormID)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
            parameters[0].Value = FormID;
            DataTable dt = DBHelper.ExecutedProcedure("Biz.OA_SealOfBC_Get", parameters);
            SealOfBCInfo Info = new SealOfBCInfo();
        ...
        #endregion
        //app3012
        public SealOfBCInfo GetSealOfBCInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
