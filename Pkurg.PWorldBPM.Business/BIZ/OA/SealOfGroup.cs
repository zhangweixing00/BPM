...
namespace Pkurg.PWorldBPM.Business.BIZ
{
    public class SealOfGroup
    {
        ...
        /// <returns></returns>
        public bool Insert(SealOfGroupInfo model)
        {
            string sql = string.Format("INSERT INTO Biz.OA_SealOfGroup (FormID,SecurityLevel,UrgenLevel,DeptName ,DeptCode,UserName," +
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool Update(SealOfGroupInfo model)
        {
            string sql = string.Format("Update Biz.OA_SealOfGroup set SecurityLevel='{0}',UrgenLevel = '{1}',DeptName = '{2}',DeptCode='{3}'," +
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_SealOfGroup SET  IsApproval = '{0}'"
        ...
        {
            string sql = string.Format("DELETE FROM Biz.OA_SealOfGroup WHERE FormID='{0}'", FormID);
            return DBHelper.ExecuteNonQuery(sql);
        }

        public SealOfGroupInfo Get(string FormID)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
            parameters[0].Value = FormID;
            DataTable dt = DBHelper.ExecutedProcedure("Biz.OA_SealOfGroup_Get", parameters);
            SealOfGroupInfo Info = new SealOfGroupInfo();
        ...
        #endregion
        //app3010
        public SealOfGroupInfo GetSealOfGroupInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
