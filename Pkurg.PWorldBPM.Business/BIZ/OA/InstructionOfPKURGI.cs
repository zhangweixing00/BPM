...
{
    public class InstructionOfPKURGI
    {
        ...
        /// <returns></returns>
        public bool Insert(InstructionOfPKURGIInfo model)
        {
            string sql = string.Format("INSERT INTO Biz.OA_InstructionOfPKURGI (FormID,SecurityLevel,UrgenLevel,DeptName ,DeptCode,UserName," +
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool Update(InstructionOfPKURGIInfo model)
        {
            string sql = string.Format("Update Biz.OA_InstructionOfPKURGI set SecurityLevel='{0}',UrgenLevel = '{1}',DeptName = '{2}',DeptCode='{3}'," +
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_InstructionOfPKURGI SET  IsApproval = '{0}'"
        ...
        {
            string sql = string.Format("DELETE FROM Biz.OA_InstructionOfPKURGI WHERE FormID='{0}'", FormID);
            return DBHelper.ExecuteNonQuery(sql);
        }

        public InstructionOfPKURGIInfo Get(string FormID)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
            parameters[0].Value = FormID;
            DataTable dt = DBHelper.ExecutedProcedure("Biz.OA_InstructionOfPKURGI_Get", parameters);
            InstructionOfPKURGIInfo Info = new InstructionOfPKURGIInfo();
        ...
        /// <param name="formId"></param>
        /// <returns></returns>
        public InstructionOfPKURGIInfo GetInstructionInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[]{
                new SqlParameter("@FormID", System.Data.SqlDbType.NVarChar, 100)
            };
