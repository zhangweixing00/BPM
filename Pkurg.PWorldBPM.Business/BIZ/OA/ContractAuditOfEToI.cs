...
{
   public class ContractAuditOfEToI
    {
        /// <summary>
        /// 通过FormID得到ContractAuditOfEToIInfo的信息
        /// </summary>
        /// <param name="p"></param>
        /// <returns></returns>
       public ContractAuditOfEToIInfo Get(string FormID)
        {
           ...
           new SqlParameter("@FormID",System.Data.SqlDbType.NVarChar,100),
            ...
            ContractAuditOfEToIInfo model = new ContractAuditOfEToIInfo();
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfEToIInfoByFormID_Get", parameters);
        ...
        /// <returns></returns>
       private ContractAuditOfEToIInfo DataRowToModel(DataRow dataRow)
        {
            ContractAuditOfEToIInfo info = new ContractAuditOfEToIInfo();
       ...
       public void Insert(ContractAuditOfEToIInfo model)
        {
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfEToIInfo_Insert", parameters);
        }
        /// <summary>
        /// 更新表
        /// </summary>
        /// <param name="obj"></param>
       public void Update(ContractAuditOfEToIInfo model)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@FormID", SqlDbType.NVarChar,100),
					new SqlParameter("@SecurityLevel", SqlDbType.NVarChar,100),
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfEToIInfo_Update", parameters);
        }
        /// <summary>
        /// 更新状态
        /// </summary>
        ...
        {
            string sql = string.Format("UPDATE Biz.OA_ContractAuditOfEToI SET  IsApproval = '{0}'"
       ...
       /// <returns></returns>
        public ContractAuditOfEToIInfo GetInfoByWfId(string wfInstanceId)
        {
            SqlParameter[] parameters = new SqlParameter[]{
            ...
            DataTable dataTable = DBHelper.ExecutedProcedure("Biz.OA_ContractAuditOfEToI_GetBywfId", parameters);
            if (dataTable != null && dataTable.Rows.Count > 0)
            {
                return DataRowToModel(dataTable.Rows[0]);
            }
       ...
       //app3006
        public ContractAuditOfEToIInfo GetContractAuditOfEToIInfo(string formId)
        {
            SqlParameter[] parameters = new SqlParameter[] { 
           new SqlParameter("@FormID",System.Data.SqlDbType.NVarChar,100),
           };
